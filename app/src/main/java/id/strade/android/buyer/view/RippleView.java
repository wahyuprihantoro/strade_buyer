package id.strade.android.buyer.view;
...
public class RippleView extends com.andexert.library.RippleView {
    ...
    private com.andexert.library.RippleView.OnRippleCompleteListener onCompletionListener;
    ...
    public com.andexert.library.RippleView.RippleType getRippleType() {
        return com.andexert.library.RippleView.RippleType.values()[rippleType];
    }
     ...
     */
    public void setRippleType(final com.andexert.library.RippleView.RippleType rippleType) {
    ...
    public void setOnRippleCompleteListener(com.andexert.library.RippleView.OnRippleCompleteListener listener) {
    ...
    public interface OnRippleCompleteListener {
        void onComplete(com.andexert.library.RippleView rippleView);
    }
}
